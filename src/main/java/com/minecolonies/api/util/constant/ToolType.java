...
public enum ToolType implements IToolType
{
    ...
    SHEARS("shears", true, Component.translatable(ToolTranslationConstants.TOOL_TYPE_SHEARS)),
//    SHEARS("shears", false, Component.translatable(ToolTranslationConstants.TOOL_TYPE_SHEARS)),
    SHIELD("shield", true, Component.translatable(ToolTranslationConstants.TOOL_TYPE_SHIELD)),
