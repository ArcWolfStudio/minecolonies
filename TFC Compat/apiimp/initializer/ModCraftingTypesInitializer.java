...
public final class ModCraftingTypesInitializer
{
    ...
    static
    {
            ...
            ModCraftingTypes.COOKPOT = DEFERRED_REGISTER.register(ModCraftingTypes.COOKPOT_ID.getPath(), () -> new RecipeCraftingType<>(ModCraftingTypes.COOKPOT_ID,
                    TFCRecipeTypes.POT.get(), null));
    }
}
