...
public final class BuildingConstants
{
    ...
    public static final String MODULE_FIREPLACETFC = "fireplace";
//    public static final String MODULE_SALADTFC = "salad";
    public static final String MODULE_ANVILTFC = "anvil";
    public static final String MODULE_CRUCIBLETFC = "crucible";
    public static final String MODULE_COOKPOTTFC = "cookpot";
