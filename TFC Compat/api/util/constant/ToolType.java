...
//    FISHINGROD("rod", false, Component.translatable(ToolTranslationConstants.TOOL_TYPE_FISHING_ROD)),
    FISHINGROD("rod", true, Component.translatable(ToolTranslationConstants.TOOL_TYPE_FISHING_ROD)), //0.1.41 variable to true
//    SHEARS("shears", false, Component.translatable(ToolTranslationConstants.TOOL_TYPE_SHEARS)),
    SHEARS("shears", true, Component.translatable(ToolTranslationConstants.TOOL_TYPE_SHEARS)), //0.1.3 test turning off shear variance 0.1.5 back on
    ...
    //SCYTHE("scythe", true, Component.translatable(ToolTranslationConstants.TOOL_TYPE_SCYTHE));
