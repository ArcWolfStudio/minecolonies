...
public final class ToolLevelConstants
{
     ...
     * TFC change TOOL_LEVEL_WOOD_OR_GOLD = 0 -> TOOL_LEVEL_COPPER = 1
     */
    @NonNls
//    public static final int TOOL_LEVEL_WOOD_OR_GOLD        = 0;
    public static final int TOOL_LEVEL_COPPER = 0;
//    public static final int TOOL_LEVEL_COPPER = 1;

    /**
     * Tool level for stone.
     *  TFC change BASIC_TOOL_LEVEL = 1 -> TOOL_LEVEL_BRONZE = 2
     */
    @NonNls
//    public static final int BASIC_TOOL_LEVEL        = 1;
    public static final int TOOL_LEVEL_BRONZE = 1;
//    public static final int TOOL_LEVEL_BRONZE = 2;
