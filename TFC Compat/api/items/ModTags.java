...
public class ModTags
{
    ...
    public static final TagKey<Block> tfc_saplings = BlockTags.create(TagConstants.TFC_SAPLINGS);

    public static final TagKey<Block> logs = BlockTags.create(TagConstants.TFC_LOGS);

    public static final TagKey<Item> fertilizer = ItemTags.create(TagConstants.FERTILIZER);
