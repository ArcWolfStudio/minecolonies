...
public class EntityAIWorkFisherman extends AbstractEntityAISkill<JobFisherman, BuildingFisherman>
{
    ...
    {
        if (checkForToolOrWeapon(ToolType.FISHINGROD)) //0.1.41 variable set to true, see if TFC rods now work.
        {
    ...
    {
        return InventoryUtils.hasItemHandlerToolWithLevel(getInventory(), ToolType.FISHINGROD, TOOL_LEVEL_COPPER, building.getMaxToolLevel())
