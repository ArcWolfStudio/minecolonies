...
public class BuildingLumberjack extends AbstractBuilding
{
     ...
     *
     * TFC Need to add Scythe at tool instead of hoe
     *
     * @param c the colony.
...
//        keepX.put(itemStack -> ItemStackUtils.hasToolLevel(itemStack,ToolType.SCYTHE , TOOL_LEVEL_COPPER, getMaxToolLevel()), new Tuple<>(1, true));
    }
