...
import com.minecolonies.coremod.util.SoupPotRecipes;
...
public class BuildingCook extends AbstractBuilding
{
    ...
    /**
     * Adding TFC crafting GUIs and recipes
     * cook needs fireplace, salad, and crafting grid
     */
//    public static class SaladModule extends AbstractCraftingBuildingModule.Saladtfc
//    {
//        /**
//         * Create a new module.
//         *
//         * @param jobEntry the entry of the job.
//         */
//        public SaladModule(final JobEntry jobEntry)
//        {
//            super(jobEntry);
//        }
//
...
//        }
//    }
    public static class CookPotModule extends AbstractCraftingBuildingModule.CookpotTFC
    {
        /**
         * Create a new module.
         *
         * @param jobEntry the entry of the job.
         */
        public CookPotModule(final JobEntry jobEntry)
        {
            super(jobEntry);
        }
        ...
        public IRecipeStorage getFirstRecipe(final Predicate<ItemStack> stackPredicate)
        {
            ...
            //If we didn't have a stored recipe, see if there is a smelting recipe that is also a food output, and use it.
            storage = SoupPotRecipes.getInstance().getFirstSmeltingRecipeByResult(stackPredicate);
            if(storage != null && storage.getRecipeSource() != null && ISFOOD.test(storage.getPrimaryOutput()) && isRecipeCompatible(GenericRecipe.of(storage)))
            {
                return storage;
            }
