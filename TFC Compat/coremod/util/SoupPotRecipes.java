...
public class SoupPotRecipes extends SoupPotRecipe
{
    ...
    public SoupPotRecipes(ResourceLocation id, List<Ingredient> itemIngredients, FluidStackIngredient fluidIngredient, int duration, float minTemp) {
    ...
    /**
        ...
        public void loadRecipes(final RecipeManager recipeManager, final Level level)
        {
            ...
            recipeManager.byType(TFCRecipeTypes.POT.get()).values().forEach(recipe -> {
